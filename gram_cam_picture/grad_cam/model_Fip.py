...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        # self._fc4 = nn.Linear(15360, 1000)
    ...
    def extract_features(self, inputs,bs):
        ...
        for idx, block in enumerate(self._blocks):
            ...
            # if n==2:
            #     x1 = x.clone()
            #     # x1 = self._swish(self._bn2(self._conv_head1(x1)))
            #     x1 = x1.view(bs, -1)
            #     x1 = self._fcx1(x1)
            #     x1 = self._fcx11(x1)
            #     x1 = self._fcx12(x1)
            ...
            if n == 4:
                x2 = x.clone()
                # x2 = self._swish(self._bn2(self._conv_head2(x2)))
                x2 = self.avgpool1(x2)
                # x2 = self.maxpool1(x2)
                # print("x2:",x2.size())
                x2 = x2.view(bs, -1)
    ...
    def forward(self, inputs):
        ...
        #
        # x4 = self.extract_features(inputs, bs)
        # # print(x.size())
