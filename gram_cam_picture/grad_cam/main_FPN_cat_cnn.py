...
def main():
    ...
    pthfile = './b0_disease_model_FPN_cat_zeyou_vote_400-300-2_2.pth'
    ...
    target_layers = []
    target_layers.append(model.toplayer)
    target_layers.append(model.smooth3)
    target_layers.append(model.smooth2)
    target_layers.append(model.smooth1)
    print(target_layers)
