...
if __name__ == '__main__':
    ...
    test = r'/home/jinfei/PycharmProjects/EfficientNet-Pytorch-master/efficientnet_realsize/400-300-2_test.txt'
    ...
    test_loader = torch.utils.data.DataLoader(dataset=test_data, batch_size=180, shuffle=False, num_workers=0)
    print("training on ", device)
    net =EfficientNet.from_name("efficientnet-b0")
    net._fc1 = nn.Linear(50, 5)

    pretext_model = torch.load('./pth/b0_disease_model_FPN_cat_zeyou_vote+x_500~1000epo_LR.pth')
    ...
    # c_w=1 # 统计测试集中识别错误的数量
    # c_r=1 # 统计测试集中识别正确的数量
    # # img_wrong_path=r'F:\EfficientNet-Pytorch-master\特征金字塔\FPN\pythoncodes\最大池化层_4_fc_add\analysis\wrong\wrong1'
    # # img_right_path=r'F:\EfficientNet-Pytorch-master\特征金字塔\FPN\pythoncodes\最大池化层_4_fc_add\analysis\right\right1'
    ...
    with torch.no_grad():
        for train_data in tqdm(test_loader):
            ...
            y_hat, y_hat2, y_hat3, y_hat4 = net(test_images)
