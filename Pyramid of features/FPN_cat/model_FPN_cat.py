...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        # delete
        self._fcx2 = nn.Linear(5600, 1000)
        self._fcx21 = nn.Linear(1000, 100)
        self._fcx22 = nn.Linear(100, 5)

        self._fcx3 = nn.Linear(1400, 100)
        self._fcx31 = nn.Linear(100, 5)

        self._fcx4 = nn.Linear(240, 50)
        self._fcx41 = nn.Linear(50, 5)

        # #no delete
        # self._fcx2 = nn.Linear(20160, 1000)
        # self._fcx21 = nn.Linear(1000, 100)
        # self._fcx22 = nn.Linear(100, 5)
        #
        # self._fcx3 = nn.Linear(4200, 1000)
        # self._fcx31 = nn.Linear(1000, 100)
        # self._fcx32 = nn.Linear(100, 5)
        #
        # self._fcx4 = nn.Linear(480, 50)
        # self._fcx41 = nn.Linear(50, 5)

        # self._fc3 = nn.Linear(15360, 1000)
        self._fc2 = nn.Linear(480, 50)
        self._fc1 = nn.Linear(50, self._global_params.num_classes)
        # self._fc1 = nn.Linear(50, 5)
    ...
    #
    #     # Lateral layers
    #     self.latlayer1 = nn.Conv2d(80, 24, kernel_size=1, stride=1, padding=0)
    ...
    #     return F.upsample(x, size=(H, W), mode='bilinear') + y
        ...
        # Top layer
        self.toplayer = nn.Conv2d(320, 40, kernel_size=1, stride=1, padding=0)  # Reduce channels

        # Smooth layers
        self.smooth1 = nn.Conv2d(80, 40, kernel_size=3, stride=1, padding=1)
        self.smooth2 = nn.Conv2d(120, 40, kernel_size=3, stride=1, padding=1)
        self.smooth3 = nn.Conv2d(144, 40, kernel_size=3, stride=1, padding=1)

        # # Smooth layers #no delete
        # self.smooth1 = nn.Conv2d(80, 80, kernel_size=3, stride=1, padding=1)
        # self.smooth2 = nn.Conv2d(120, 120, kernel_size=3, stride=1, padding=1)
        # self.smooth3 = nn.Conv2d(144, 144, kernel_size=3, stride=1, padding=1)

        # Lateral layers
        self.latlayer1 = nn.Conv2d(112, 40, kernel_size=1, stride=1, padding=0)
        self.latlayer2 = nn.Conv2d(40, 40, kernel_size=1, stride=1, padding=0)
        self.latlayer3 = nn.Conv2d(24, 24, kernel_size=1, stride=1, padding=0)
