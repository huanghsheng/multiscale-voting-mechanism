...
if __name__ == '__main__':
    ...
    pretext_model = torch.load('./b0_disease_model_FPN_cat_StepLR_400-300-2.pth')
    ...
    # c_w=1 # 统计测试集中识别错误的数量
    # c_r=1 # 统计测试集中识别正确的数量
    # img_wrong_path=r'F:\EfficientNet-Pytorch-master\MTL_efficientNet\pythoncodes\10.7\2\analysis\wrong1'
    # img_right_path=r'F:\EfficientNet-Pytorch-master\MTL_efficientNet\pythoncodes\10.7\2\analysis\right1'
    # batch_size=4
