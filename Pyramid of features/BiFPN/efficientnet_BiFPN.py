...
import torchvision
import sys
from model_BiFPN import EfficientNet
...
def evaluate_accuracy(data_iter, net,device=None):
    ...
    f = open("//home//jinfei//PycharmProjects//pythoncodes//BiFPN_test time.txt", "a")
    t1 = time.time()
    with torch.no_grad():
        batch_count = 0
...
def train(train_iter, test_iter, net, loss, optimizer, device, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch+1)>290:
            torch.save(net.module.state_dict(), "./weights/b0_BiFPN-{}.pth".format(epoch+1))
...
# net._fc1 = nn.Linear(50, 5)
# pretext_model = torch.load('./pth/b0_disease_model_BiFPN_400-300-2.pth')
# net_dict = net.state_dict()
# state_dict = {k: v for k, v in pretext_model.items() if k in net_dict.keys()}
# net_dict.update(state_dict)
# net.load_state_dict(net_dict)
...
torch.save(net.module.state_dict(), "///home//jinfei//PycharmProjects//pythoncodes//b0_chidu//b0_disease_model_BiFPN_400-300-2.pth")