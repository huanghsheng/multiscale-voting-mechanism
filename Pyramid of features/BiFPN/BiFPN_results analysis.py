...
if __name__ == '__main__':
    ...
    pretext_model = torch.load('./pth/b0_disease_model_BiFPN_400-300-2_800.pth')
    ...
    # c_w=1 # 统计测试集中识别错误的数量
    # c_r=1 # 统计测试集中识别正确的数量
    # img_wrong_path=r'F:\EfficientNet-Pytorch-master\analysis\wrong'
    # img_right_path=r'F:\EfficientNet-Pytorch-master\analysis\right'
    # batch_size=4
