...
def READ(num_epochs,device,batch_size,optimizer,loss,net):
    # train_k = r'/home/jinfei/PycharmProjects/EfficientNet-Pytorch-master/data_10_train.txt'
    # test_k = r'/home/jinfei/PycharmProjects/EfficientNet-Pytorch-master/data_10_test.txt'
...
def evaluate_accuracy(data_iter, net, device=None):
    ...
    f = open("//home//jinfei//PycharmProjects//pythoncodes//Googlenet-V3_test time.txt", "a")
    t1 = time.time()
    with torch.no_grad():
        batch_count = 0
...
def train(train_iter, test_iter, net, loss, optimizer, device, num_epochs):
    ...
    f2 = open("//home//jinfei//PycharmProjects//pythoncodes//results data.txt", "a")
    start = time.time()
    test_acc_max_l = []
    test_l_min_l = []
    train_acc_max_l = []
    ...
    for epoch in range(num_epochs):  
        ...
        # if (epoch+1)%100==0:
        #     torch.save(net.module.state_dict(), "./weights/googlenet-{}.pth".format(epoch+1))
...
torch.save(net.module.state_dict(), "//home//jinfei//PycharmProjects//pythoncodes//googlenet_disease_model_400_300_2.pth")