...
def evaluate_accuracy(data_iter, net, device=None):
    ...
    f = open("//home//jinfei//PycharmProjects//pythoncodes//Densenet_test time.txt", "a")
    t1 = time.time()
    with torch.no_grad():
        batch_count = 0
...
def train(train_iter, test_iter, net, loss, optimizer, device, num_epochs):
    ...
    for epoch in range(num_epochs):  
        ...
        # if (epoch+1)%100==0:
        #     torch.save(net.module.state_dict(), "./weights/densenet-{}.pth".format(epoch+1))
...
torch.save(net.module.state_dict(), "//home//jinfei//PycharmProjects//pythoncodes//densenet_disease_model_400_300_2.pth")