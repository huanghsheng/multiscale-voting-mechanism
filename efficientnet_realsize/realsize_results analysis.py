...
if __name__ == '__main__':
    ...
    test = r'/home/jinfei/PycharmProjects/EfficientNet-Pytorch-master/efficientnet_realsize/400-300-3_test.txt'
    ...
    pretext_model = torch.load('./b0_disease_model_400-300-3_epoch1000.pth')
    ...
    # c_w=1 # 统计测试集中识别错误的数量
    # c_r=1 # 统计测试集中识别正确的数量
    # img_wrong_path=r'/home/jinfei/PycharmProjects/EfficientNet-Pytorch-master/efficientnet_realsize/analysis/400-300_3/wrong/wrong'
    # img_right_path=r'/home/jinfei/PycharmProjects/EfficientNet-Pytorch-master/efficientnet_realsize/analysis/400-300_3/right/right'
    # batch_size=180
