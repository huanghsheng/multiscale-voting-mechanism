...
if __name__ == '__main__':
    ...
    pretext_model = torch.load('./pth/googlenet_disease_model_400_300_2.pth')
    ...
    # c_w=1 # 统计测试集中识别错误的数量
    # c_r=1 # 统计测试集中识别正确的数量
    # img_wrong_path=r'F:\EfficientNet-Pytorch-master\Test10_regnet\pythoncodes\300_224\analysis\wrong\wrong1'
    # img_right_path=r'F:\EfficientNet-Pytorch-master\Test10_regnet\pythoncodes\300_224\analysis\right\right1'
    # batch_size=4
