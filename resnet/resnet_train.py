...
def evaluate_accuracy(data_iter, net, device=None):
    ...
    f = open("//home//jinfei//PycharmProjects//pythoncodes//Resnet_test time.txt", "a")
    t1 = time.time()
    with torch.no_grad():
        batch_count = 0
...
torch.save(net.module.state_dict(), "//home//jinfei//PycharmProjects//pythoncodes//resnet50_disease_model_400_300_2.pth")